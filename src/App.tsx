...
export default function OceanTrace() {
  ...
  return (
    ...
    >
      ...
      {/* Swimming fish */}
      <div className="animate-swim" style={{ position: "absolute", top: "8rem", left: 0, opacity: 0.8, zIndex: 0 }}>
        <Icon name="water_full" filled style={{ fontSize: 60, color: "#FF6B6B", transform: "scaleX(-1)" }} />
      </div>
      <div className="animate-swim-slow" style={{ position: "absolute", top: "16rem", left: 0, opacity: 0.6, zIndex: 0 }}>
        <Icon name="sailing" style={{ fontSize: 40, color: "#F9D56E", transform: "scaleX(-1)" }} />
      </div>
      ...
      {/* Main content */}
      <main style={{ position: "relative", zIndex: 10, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", width: "100%", maxWidth: 448, margin: "0 auto", padding: "0 1rem 2rem" }}>
